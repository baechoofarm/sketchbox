...
import {getLeafOfSelection, SketchboxEditor, FormatChangeFunction, SketchboxFormatIndex} from "../../../../../internal";

export function useFormatChanger<T extends SketchboxFormatIndex, U>(
